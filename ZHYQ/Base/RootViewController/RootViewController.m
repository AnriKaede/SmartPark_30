...
-(void)showNoDataImageWithY:(CGFloat)pointY {
    [self showNoDataImage];
    
    CGRect frame = _noDataView.frame;
    _noDataView.frame = CGRectMake(frame.origin.x, pointY, frame.size.width, frame.size.height);
}
