...
@implementation CheckTaskHomeViewController
...
- (void)_initView {
    ...
    [_tableView registerNib:[UINib nibWithNibName:@"CheckTaskHomeCell" bundle:nil] forCellReuseIdentifier:@"CheckTaskHomeCell"];
