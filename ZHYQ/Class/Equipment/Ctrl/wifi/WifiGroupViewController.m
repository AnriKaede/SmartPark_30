...
@interface WifiGroupViewController ()<UITableViewDelegate, UITableViewDataSource>
{
...
@implementation WifiGroupViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if(topModel.IS_OUT.integerValue == 1){
        OutDoorWifiViewController *outVC = [[OutDoorWifiViewController alloc] init];
        [self.navigationController pushViewController:outVC animated:YES];
    }else {
        InDoorWifiViewController *inVC = [[InDoorWifiViewController alloc] init];
