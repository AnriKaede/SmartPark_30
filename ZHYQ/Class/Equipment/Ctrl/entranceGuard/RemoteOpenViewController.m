...
@interface RemoteOpenViewController ()<UITableViewDelegate, UITableViewDataSource, CYLTableViewPlaceHolderDelegate>
{
...
@implementation RemoteOpenViewController
...
-(void)_loadData
{
    NSString *urlStr = [NSString stringWithFormat:@"%@/visitor/getTelecontrolOpenDoorLog",Main_Url];
    ...
    [[NetworkClient sharedInstance] POST:urlStr dict:param progressFloat:nil succeed:^(id responseObject) {
        ...
        if ([responseObject[@"code"] isEqualToString:@"1"]) {
            ...
            [arr enumerateObjectsUsingBlock:^(id  _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
                RemoteModel *model = [[RemoteModel alloc] initWithDataDic:obj];
...
//    cell.model = self.dataArr[indexPath.section];
    cell.remoteModel = self.dataArr[indexPath.section];
