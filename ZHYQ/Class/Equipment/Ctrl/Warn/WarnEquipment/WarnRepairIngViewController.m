...
@interface WarnRepairIngViewController ()<CYLTableViewPlaceHolderDelegate>
{
...
@implementation WarnRepairIngViewController
...
- (void)_loadData {
    ...
    [paramDic setObject:@"1" forKey:@"alarmState"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.wranBillStyle = WranRepairing;
