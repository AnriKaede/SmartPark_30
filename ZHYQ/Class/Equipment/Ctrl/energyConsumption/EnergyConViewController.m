...
@interface EnergyConViewController ()<UIScrollViewDelegate>
{
...
@implementation EnergyConViewController
...
{
    //电表
    ElectricMeterViewController *electricMetVC = [[ElectricMeterViewController alloc] init];
    electricMetVC.title = @"电表";
    [self addChildViewController:electricMetVC];
    
    //水表
    WaterMeterViewController *waterMetVC = [[WaterMeterViewController alloc] init];
    waterMetVC.title = @"水表";
    [self addChildViewController:waterMetVC];
