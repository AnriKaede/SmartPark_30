...
@interface MusicGroupViewController ()<UITableViewDelegate, UITableViewDataSource>
{
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if(topModel.IS_OUT.integerValue == 1){
        OutDoorBgMusicViewController *outVC = [[OutDoorBgMusicViewController alloc] init];
        [self.navigationController pushViewController:outVC animated:YES];
    }else {
        InDoorBgMusicViewController *inVC = [[InDoorBgMusicViewController alloc] init];
