...
@implementation ParkRecordFilterView
{
    UIView *_bgView;
...
- (void)_initView {
    ...
    beginLabel.tag = 5000;
    beginLabel.frame = CGRectMake(18, 20, 70, 17);
...
- (void)certainAction {
    ...
    // 筛选
    if(_filterTimeDelegate && [_filterTimeDelegate respondsToSelector:@selector(filterWithStart:withEndTime:)]){
        [_filterTimeDelegate filterWithStart:inputStartStr withEndTime:inputEndStr];
    }
}
