...
- (void)setContentItem:(DCContentItem *)contentItem
{
    ...
    if (contentItem.isSelect) {
        ...
        _contentButton.backgroundColor = [UIColor colorWithHexString:@"1B82D1"];

//        [YQTools dc_chageControlCircularWith:self AndSetCornerRadius:3 SetBorderWidth:1 SetBorderColor:[UIColor redColor] canMasksToBounds:YES];
    }else{
...
//        _contentButton.backgroundColor = RGB(230, 230, 230);
        _contentButton.backgroundColor = [UIColor colorWithHexString:@"F3F3F3"];
        
//        [YQTools dc_chageControlCircularWith:self AndSetCornerRadius:3 SetBorderWidth:1 SetBorderColor:RGB(230, 230, 230) canMasksToBounds:YES];
    }
}
