...
#import "BaseModel.h"
#import "MeetRoomDeviceModel.h"

@interface MeetRoomModel : BaseModel
...
@property (nonatomic,copy) NSArray *airList;

@property (nonatomic, strong) NSNumber *LightValue; // 默认100

@property (nonatomic, copy) NSString *current_state;   // 设备开关状态 255 开  0 关  1-255 筒灯亮度 取百分比
