...
#import "NewPdViewController.h"
#import "LogViewCtrl.h"
#import "ForgetPdViewController.h"

@interface NewPdViewController ()
{
    UIView *bgView;
...
@implementation NewPdViewController
...
-(void)okClick
{
    ...
    __weak NewPdViewController * weakSelf = self;
