...
-(void)createTextFields
{
    ...
    [yzButton.titleLabel setFont:[UIFont systemFontOfSize:13]];
...
- (void)getValidCode:(UIButton *)sender
{
    ...
    self.timeCount = 60;
    __weak ForgetPdViewController *weakSelf = self;
...
-(void)landClick
{
    ...
    NewPdViewController *new = [[NewPdViewController alloc]init];
    //赋值
