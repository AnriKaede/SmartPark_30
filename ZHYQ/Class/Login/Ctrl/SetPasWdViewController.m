...
#import "SetPasWdViewController.h"
#import "SetPerMsgViewController.h"


@interface SetPasWdViewController ()
{
    UIView *bgView;
...
@implementation SetPasWdViewController
...
{
    UILabel *label = [[UILabel alloc]initWithFrame:CGRectMake(30, 10, self.view.frame.size.width-90, 30)];
    label.text = @"请设置密码";
...
-(void)landClick
{
    ...
    //        return;
    //    }
    [self.navigationController pushViewController:[[SetPerMsgViewController alloc]init] animated:YES];
