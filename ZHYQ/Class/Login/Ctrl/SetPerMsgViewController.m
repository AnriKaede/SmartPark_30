...
#import "SetPerMsgViewController.h"
#import "LogViewCtrl.h"

@interface SetPerMsgViewController ()<UIActionSheetDelegate,UIImagePickerControllerDelegate>
{
    UIView *bgView;
...
@implementation SetPerMsgViewController
...
-(void)landClick
{
    [self.navigationController pushViewController:[[LogViewCtrl alloc]init] animated:YES];
...
-(void)createUI
{
    ...
    _head = [[UIButton alloc]initWithFrame:CGRectMake((self.view.frame.size.width-80)/2, 55, 80, 80)];
    ...
    UILabel *label = [[UILabel alloc]initWithFrame:CGRectMake((self.view.frame.size.width-80)/2, 125, 80, 80)];
    label.text = @"点击设置头像";
