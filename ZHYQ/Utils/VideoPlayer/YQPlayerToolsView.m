...
#import "YQPlayerToolsView.h"
#import "YQVideoPlayerConst.h"
#import <MediaPlayer/MediaPlayer.h>

@interface YQPlayerToolsView()
//点击手势
@property (nonatomic, strong) UIPanGestureRecognizer *tapGesture;

@end

@implementation YQPlayerToolsView
...
- (void)layoutSubviews
{
    ...
    self.topBar.frame             = CGRectMake(CGRectGetMinX(self.bounds), CGRectGetMinY(self.bounds), CGRectGetWidth(self.bounds), YQ_VideoControlBarHeight);
    ...
    self.bottomBar.frame          = CGRectMake(CGRectGetMinX(self.bounds), CGRectGetHeight(self.bounds) - YQ_VideoControlBarHeight, CGRectGetWidth(self.bounds), YQ_VideoControlBarHeight);
    
    self.progressSlider.frame     = CGRectMake(0, -0, CGRectGetWidth(self.bounds), YQ_VideoControlSliderHeight);
...
- (void)animateHide
{
    [UIView animateWithDuration:YQ_VideoControlAnimationTimeinterval animations:^{
        self.topBar.alpha = 0;
...
- (void)autoFadeOutControlBar
{
    ...
    //开始延迟执行
    [self performSelector:@selector(animateHide) withObject:nil afterDelay:YQ_VideoControlBarAutoFadeOutTimeinterval];
}
...
- (UIButton *)playBtn
{
    if (!_playBtn) {
        ...
        _playBtn.bounds = CGRectMake(0, 0, YQ_VideoControlBarHeight, YQ_VideoControlBarHeight);
    }
    return _playBtn;
}
...
- (UIButton *)pauseBtn
{
    if (!_pauseBtn) {
        ...
        _pauseBtn.bounds = CGRectMake(0, 0, YQ_VideoControlBarHeight, YQ_VideoControlBarHeight);
    }
    return _pauseBtn;
}
...
- (UIButton *)fullScreenBtn
{
    if (!_fullScreenBtn) {
        ...
        _fullScreenBtn.bounds = CGRectMake(0, 0, YQ_VideoControlBarHeight, YQ_VideoControlBarHeight);
    }
...
- (UIButton *)smallScreenBtn
{
    if (!_smallScreenBtn) {
        ...
        [_smallScreenBtn setImage:[UIImage imageNamed:@"smallscreen"] forState:UIControlStateNormal];
        _smallScreenBtn.bounds = CGRectMake(0, 0, YQ_VideoControlBarHeight, YQ_VideoControlBarHeight);
    }
...
- (UIButton *)closeBtn
{
    if (!_closeBtn) {
        ...
        _closeBtn.bounds = CGRectMake(0, 0, YQ_VideoControlBarHeight, YQ_VideoControlBarHeight);
    }
    return _closeBtn;
}
...
- (UILabel *)timeLabel
{
    if (!_timeLabel) {
        ...
        _timeLabel.font = [UIFont systemFontOfSize:YQ_VideoControlTimeLabelFontSize];
        _timeLabel.textColor = [UIColor lightGrayColor];
        _timeLabel.textAlignment = NSTextAlignmentLeft;
        _timeLabel.bounds = CGRectMake(0, 0, YQ_VideoControlTimeLabelFontSize, YQ_VideoControlBarHeight);
    }
    return _timeLabel;
}
