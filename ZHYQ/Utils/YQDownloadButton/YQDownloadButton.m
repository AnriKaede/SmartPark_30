...
//    _bottomColor = [UIColor colorWithRed:79/255.0 green:240/255.0 blue:255/255.0 alpha:.3];
    _topColor = [UIColor colorWithRed:58/255.2f green:130/255.2f blue:203/255.2f alpha:1];
    _bottomColor = [UIColor colorWithRed:58/255.2f green:130/255.2f blue:203/255.2f alpha:0.3];
...
- (void)showLogoAnim {
    ...
    [button setBackgroundImage:[UIImage imageNamed:@"home_today_count"] forState:UIControlStateNormal];
...
- (void)selAction {
    if(_todayClickDelegate != nil){
        [_todayClickDelegate todayClick];
    }
}
...
- (UIView *)vibrationWaveView {
    if (!_vibrationWaveView) {
        _vibrationWaveView = [[UIView alloc] initWithFrame: CGRectMake(0, 0, self.width, self.height)];
